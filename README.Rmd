...
mmtravis is an R-package to conveniently visualise and analyse NGS transcriptomics data in different ways. \strong{NOTE: This is still in development, so don't expect everything to be working perfectly - yet!}
...
## Get started
Keep an eye out for or get started page, Comming soon! For now, go to the [References](https://tymichaelsen.github.io/mmtravis/) page to see a list of available functions. 

## Blog posts about mmtravis
Keep an eye out for upcomming blogposts at [http://albertsenlab.org/](http://albertsenlab.org/) about mmtravis
